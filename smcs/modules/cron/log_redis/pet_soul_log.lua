----------------------------------------
--$Id: pet_soul_log.lua 4082 2014-05-19 02:44:03Z zork $
----------------------------------------
--[[
-- 拉取petsoul.log相关日志并且入库,相关日志文件有：petsoul.log
--]]

module(...,package.seeall)

--前面的HostID和后面的时间都不要在这里填
local Cols = {"Uid", "Urs", "Name", "OperationType", "Grid", "Consume", "ItemType", "Amount"}
...
function HandleResponse(self, LogList, ServerPlatformMap)
	...
	for PlatformID, Results in pairs(PlatformResults) do
		PetSoulLogData:BatchInsert(PlatformID, Results)
	end
	return true
end
