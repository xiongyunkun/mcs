...
--
-- Host: 127.0.0.1    Database: dw_statics
-- ------------------------------------------------------
...
CREATE TABLE `tblOnlineTime` (
  `PlatformID` varchar(32) NOT NULL DEFAULT '' COMMENT 'å¹³å°ID',
  `HostID` int(11) NOT NULL DEFAULT '0' COMMENT 'æœID',
  `Date` date NOT NULL DEFAULT '0000-00-00' COMMENT 'ç»Ÿè®¡æ—¥æœŸ',
  ...
  `TotalTimes` int(11) NOT NULL DEFAULT '0' COMMENT 'æ€»æ—¶é•¿',
  `TotalPlayers` int(11) NOT NULL DEFAULT '0' COMMENT 'çŽ©å®¶æ€»æ•°',
  `Flag` varchar(8) NOT NULL DEFAULT 'true' COMMENT 'æ ‡å¿—ä½',
...
-- Dump completed on 2015-08-17 12:05:54
