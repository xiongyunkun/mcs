------------------------------------------
--$Id: pet_brand_log_data.lua 3850 2014-05-14 08:26:00Z zork $
------------------------------------------
--[[
CREATE TABLE `tblPetBrandLog` (
...
function Get(self, PlatformID, Options)
    ...
    for _, Date in ipairs(DateList) do
		local Sql = "select * from " .. PlatformID .. "_log.tblPetBrandLog_" .. Date .. Where
...
local Cols = {"HostID", "Uid", "Urs", "Name", "Grid", "ConsumeNum", "Level", "Time"}
...
function BatchInsert(self, PlatformID, Results)
	...
	for Date, DateResults in pairs(StrResults) do
		local Sql = "insert into " .. PlatformID .. "_log.tblPetBrandLog_" .. Date .. "(" 
