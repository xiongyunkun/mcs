------------------------------------------
--$Id: exp_log_data.lua 3850 2014-05-14 08:26:00Z zork $
------------------------------------------
--[[
CREATE TABLE `tblExpLog` (
...
function Get(self, PlatformID, Options)
    ...
    for _, Date in ipairs(DateList) do
		local Sql = "select * from " .. PlatformID .. "_log.tblExpLog_" .. Date .. Where
...
local Cols = {"HostID", "Uid", "Urs", "Name", "OrgExp", "ExpChange", "CurExp", "OrgLevel", 
	"CurLevel", "Reason","Time"}
...
function BatchInsert(self, PlatformID, Results)
	...
	for Date, DateResults in pairs(StrResults) do
		local Sql = "insert into " .. PlatformID .. "_log.tblExpLog_" .. Date .. "(" 
