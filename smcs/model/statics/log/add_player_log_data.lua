...
CREATE TABLE `tblAddPlayerLog` (
  ...
  PRIMARY KEY (`ID`),
  KEY `index1` (`Time`)
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=utf8 COMMENT='玩家注册日志表' 
