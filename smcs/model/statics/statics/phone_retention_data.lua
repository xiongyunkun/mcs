------------------------------------------
--$Id: phone_retention_data.lua 78972 2015-11-12 13:01:06Z jm $
------------------------------------------
--[[
CREATE TABLE `tblPhoneRetention` (
...
function Get(self, Options)
	...
	local Sql = "select * from "..PlatformID.."_statics.tblPhoneRetention " .. Where .. " order by HostID, Date"
...
function Insert(self, PlatformID, HostID, Date, RetInfo)
	local Sql = "insert into " .. PlatformID .. "_statics.tblPhoneRetention(PlatformID, HostID, Date,"..table.concat(Cols, ",")
