...
local Cols = {"PlatformID", "Uid", "RoleName", "Status", "Operator",}
...
function UpdateStatus(self, PlatformID, Uid, Status)
	local Sql = "update smcs.tblPlayerGM set Status = '" .. Status .. "' where Uid = '" .. Uid .. "' and PlatformID = '" ..PlatformID .. "'"
	DB:ExeSql(Sql)
end

--删除操作
function Delete(self, PlatformID, Uid)
	local Sql = "update smcs.tblPlayerGM set Flag = 'false' where Uid = '" .. Uid .. "' and PlatformID = '" .. PlatformID .. "'"
	DB:ExeSql(Sql)
end
