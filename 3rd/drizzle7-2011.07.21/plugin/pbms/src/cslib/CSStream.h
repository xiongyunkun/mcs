...
public:
	...
	/*
	 * 聽Reset this output stream to the start inorder to restart the write.
	 */
...
public:
	...
	/*
	 * 聽Flushes this output stream and forces any buffered output
...
public:
	...
	/*
	 * 聽Reset this output stream to the start inorder to restart the read.
	 */
	virtual void reset(); 
