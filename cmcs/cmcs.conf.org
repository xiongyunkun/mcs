root $workpath$/;
upstream cmcs {
	drizzle_server 127.0.0.1:3306 dbname=toplist
		password=smcsdb user=sysmcs charset=utf8 protocol=mysql;
}
...
location /getmysql {
	default_type "text/plain";
	set $processfunc "GetMysql";
	content_by_lua_file modules/mysqlop.lua;
}
location /mysql {
